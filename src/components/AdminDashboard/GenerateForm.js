...
function GenerateForm(props) {
    ...
    function addMoreQuestionField(){
        ...
        setQuestions(questions=> [...questions, {caption: "Question", type:"text"}]);
    };
            ...
            <section className="flex w-full justify-center">
                    <div className="flex flex-col border rounded-lg w-3/4 h-auto mt-6 pb-4 border-nord9">
                        <div className="flex flex-row justify-between mx-2 my-2">
                            <input type="text" id="ftitle" name="fname" placeholder={ques.caption} value={ques.caption} onChange={(e)=>{handleQuestionValue(e.target.value,i)}} className="h-10 border-b font-semibold text-lg mt-2 focus:bg-nord6 w-1/2 ml-2 pl-2 outline-none"></input>
                        ...
                        <div>
                            <div className="flex mx-4 mt-2">
                                <input type={ques.type} id="text1" name="textbox1" placeholder="Issues:" className="font-semibold ml-2 w-4/5 border-b outline-none"/>
                                <IconButton>
        ...
        <Dashboard/>
            ...
            <body className="h-auto w-full justify-center justify-items-center overflow-x-hidden flex flex-col">
                ...
                <section className="flex w-full justify-center hover:shadow-lg">
                    <button type="submit" onClick={handleSubmit} className="border-2 rounded-lg bg-nord10 mx-2 my-6 py-2 px-2 text-nord6 border-nord1 font-bold w-20"> Save</button>
                </section>
            </body>
            </Form>
        </>
